...
2. Record Project URL as `NEXT_PUBLIC_SUPABASE_URL` and the publishable key as `NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY`.
...
4. Never put the service role into a `NEXT_PUBLIC_*` value.
