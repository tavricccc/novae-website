...
Novae 是校內提案、附議、審核、回覆、公告與通知的 PWA。它把分散在表單、貼文與私訊裡的校園議題，整理成有權限、有狀態、有期限、可追蹤的流程。
...
| 管理員 | 審核提案、更新狀態與回覆、發布公告、處理內容並查看 Dashboard |
...
因此「公共議題 50 人／14 天」只是目前範例設定，不是系統寫死的規則。請用[分類設定產生器](../category-builder.html)建立符合學校制度的設定。
