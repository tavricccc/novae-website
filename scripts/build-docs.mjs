...
<p>These docs follow one production path. Learn the <a href="project-overview.html">product workflows</a>, use <a href="quick-start.html">preparation and service setup</a> to create the service accounts, complete the credential worksheet and category policy, then finish with <a href="deployment-guide.html">release and acceptance</a>. Local setup is only required for contributors.</p>
<ul>${list}</ul>`;
    fs.writeFileSync(
      enIndexPath,
      renderShell({
